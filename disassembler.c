...
int read_code_to_buf(const char *filepath, char ** const buf, long *bufsize) {
...
int disassemble_8080_op(const char *buf, const int pc) {
  ...
  switch (*code) {
    ...
    case 0x2a: printf("LHLD   HL,$%02x%02x", code[2], code[1]); opbytes=3; break;
    ...
    case 0x32: printf("STA    %02x%02x,A", code[2], code[1]); break;
    ...
    case 0xc2: printf("JNZ    if NZ: PC,$%02x%02x", code[2], code[1]); opbytes=3; break;
    case 0xc3: printf("JMP    PC,$%02x%02x", code[2], code[1]); opbytes=3; break;
    case 0xc4: printf("CNZ    if NZ: CALL $%02x%02x", code[2], code[1]); opbytes=3; break;
    case 0xc5: printf("PUSH   B"); break;
    case 0xc6: printf("ADI    A,A+#$%02x", code[1]); opbytes=2; break;
    case 0xc7: printf("RST    0"); break;
    case 0xc8: printf("RZ"); break;
    case 0xc9: printf("RET"); break;
    case 0xca: printf("JZ     if Z: PC,$%02x%02x", code[2], code[1]); opbytes=3; break;
    case 0xcb: printf("NOP"); break;
    case 0xcc: printf("CZ     if Z: CALL $%02x%02x", code[2], code[1]); opbytes=3; break;
    case 0xcd: printf("CALL   $%02x%02x", code[2], code[1]); opbytes=3; break;
    case 0xce: printf("ACI    A,A + #$%02x + CY", code[1]); opbytes=2; break;
    ...
    case 0xe2: printf("JPO    if PO: PC,$%02x%02x", code[2], code[1]); opbytes=3; break;
    case 0xe3: printf("XTHL"); break;
    case 0xe4: printf("CPO    if PO: CALL $%02x%02x", code[2], code[1]); opbytes=3; break;
    case 0xe5: printf("PUSH   H"); break;
    case 0xe6: printf("ANI    A,A & #$%02x", code[1]); opbytes=2; break;
    case 0xe7: printf("RST"); break;
    case 0xe8: printf("RPE"); break;
    case 0xe9: printf("PCHL"); break;
    case 0xea: printf("JPE    if PE: PC,$%02x%02x", code[2], code[1]); opbytes=3; break;
    case 0xeb: printf("XCHG"); break;
    case 0xec: printf("CPE    if PE: CALL $%02x%02x", code[2], code[1]); opbytes=3; break;
    case 0xed: printf("NOP"); break;
    case 0xee: printf("XRI    A,A ^ #$%02x", code[1]); opbytes=2; break;
    case 0xef: printf("RST"); break;

    case 0xf0: printf("RP"); break;
    case 0xf1: printf("POP    PSW"); break;
    case 0xf2: printf("JP     if P=1: PC,$%02x%02x", code[2], code[1]); opbytes=3; break;
    case 0xf3: printf("DI"); break;
    case 0xf4: printf("CP     if P: PC,$%02x%02x", code[2], code[1]); opbytes=3; break;
    case 0xf5: printf("PUSH   PSW"); break;
    case 0xf6: printf("ORI    A,A | #$%02x", code[1]); opbytes=2; break;
    case 0xf7: printf("RST"); break;
    case 0xf8: printf("RM"); break;
    case 0xf9: printf("SPHL"); break;
    case 0xfa: printf("JM     if M, PC,$%02x%02x", code[2], code[1]); opbytes=3; break;
    case 0xfb: printf("EI"); break;
    case 0xfc: printf("CM     if M, CALL $%02x%02x", code[2], code[1]); opbytes=3; break;
    case 0xfd: printf("NOP"); break;
    case 0xfe: printf("CPI    A - #$%02x", code[1]); opbytes=2; break;
    case 0xff: printf("RST"); break;
    
    default: printf("Error: hex '%02x' not recognized!", code[0]); break;
...
int disassemble_8080_code(const char *filepath) {
  ...
  if (read_code_to_buf(filepath, &buf, &bufsize) != 0) return 1;

  int pc = 0;
  while(pc < bufsize) {
    pc += disassemble_8080_op(buf, pc);
  }
